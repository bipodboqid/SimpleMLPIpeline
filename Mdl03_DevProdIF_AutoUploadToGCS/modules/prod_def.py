...
if __name__ == "__main__":
	...
	PROD_PIPELINE_NAME = 'pipeline-from-cloudfunction'
	PROD_PIPELINE_ROOT = 'gs://{}/pipeline_root/{}'.format(PROD_GCS_BUCKET_NAME, PROD_PIPELINE_NAME)
	PROD_DATA_ROOT = 'gs://mlpipelineportfolio_bucket_01/uploadFromGitHub/tfrecord'
	PROD_ENDPOINT_NAME = 'prediction-' + PROD_PIPELINE_NAME
	PROD_PIPELINE_DEFINITION_DIR = '/home/jupyter/SimpleMLPipeline/Mdl01_Model/pipeline-definition/prod/'
	...
	PROD_MODULE_FILE = 'gs://mlpipelineportfolio_bucket_01/uploadFromGitHub/modules/utils.py'
